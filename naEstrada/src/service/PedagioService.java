...
public class PedagioService {
	...
	private void inicializar() {
		...
		pedagios.add(new Pedagio("Viapar", "Campo Mourão", 10.50, latLng, "Campo Mourão - PR"));
		
		latLng = new LatLng(-23.636524, -52.107552);
		pedagios.add(new Pedagio("Viapar", "Floresta", 11.20, latLng, "Floresta - PR"));
		
		latLng = new LatLng(-25.309577, -51.168327);
		pedagios.add(new Pedagio("Caminhos do Paraná", "Relógio", 9.75, latLng, "Prudentópolis - PR"));
	}
